...
/// `jira` noun-verb routes — generated by `ggen sync` from
/// `jira-tracking-pack`'s `cnv:Command` individuals; see that file's own
/// header for why the routes live in this binary crate while the real
/// handler logic (`cng::jira`) lives in the library.
mod jira_routes;
