...
fn make_refusal(index: usize, ctx: &str) -> Refusal {
    ...
    match index {
        ...
        19 => Refusal::RouteDecisionMismatch(c),
        20 => Refusal::GraphSnapshotMismatch(c),
        21 => Refusal::ProfileHashMismatch(c),
        22 => Refusal::AgentOverrideDenied(c),
        23 => Refusal::WitnessNotAuthority(c),
        24 => Refusal::BreedUnpermitted(c),
        25 => Refusal::NondeterministicOperatorRequiresReceipt(c),
