# my-conforming-project — Developer Guide
...
A dynamically generated conforming project for verification.
...
│   ├── bin/my-conforming-project.rs  # Binary entrypoint (thin — delegates to lib)
...
This generates `my-conforming-project emit`, `my-conforming-project assemble`,
`my-conforming-project verify` as top-level subcommands. Each variant maps 1:1 to a
...
4. **Wire the match arm** in `src/bin/my-conforming-project.rs`:
...
| Run binary | `cargo run --bin my-conforming-project -- <args>` | |
