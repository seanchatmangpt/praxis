...
ln -s "$(pwd)/docs/thesis/consolidated/paper_b_planning/rdf/thesis.ttl" /tmp/doc-pack-project/ontology.ttl
...
cp /tmp/doc-pack-project/generated/chapters_body.tex "$REPO/docs/thesis/consolidated/paper_b_planning/generated/chapters_body.tex"
echo "regenerated docs/thesis/consolidated/paper_b_planning/generated/chapters_body.tex"
